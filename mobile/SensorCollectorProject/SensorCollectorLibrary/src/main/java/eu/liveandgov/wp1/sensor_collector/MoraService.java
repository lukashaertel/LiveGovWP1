...
import eu.liveandgov.wp1.sensor_collector.components.sources.BluetoothSource;
import eu.liveandgov.wp1.sensor_collector.components.Credentials;
import eu.liveandgov.wp1.sensor_collector.components.sources.GActSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.HARSource;
import eu.liveandgov.wp1.sensor_collector.components.ItemBuffer;
import eu.liveandgov.wp1.sensor_collector.components.sources.LocationSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.NotifierSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.SensorSource.AccelerometerSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.SensorSource.GravitySource;
import eu.liveandgov.wp1.sensor_collector.components.sources.SensorSource.LinearAccelerationSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.SensorSource.MagnetometerSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.SensorSource.RotationSource;
import eu.liveandgov.wp1.sensor_collector.components.targets.StreamerTarget;
import eu.liveandgov.wp1.sensor_collector.components.sources.TagSource;
import eu.liveandgov.wp1.sensor_collector.components.sources.TelephonySource;
import eu.liveandgov.wp1.sensor_collector.components.sources.WifiSource;
import eu.liveandgov.wp1.sensor_collector.components.targets.WriterTarget;
